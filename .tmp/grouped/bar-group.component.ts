...
@Component({
    ...
    template: "<div class=\"mdl-grid items\"> <div class=\"mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone\"> <form> <label><input type=\"radio\" name=\"mode\" value=\"grouped\"> Grouped</label> <label><input type=\"radio\" name=\"mode\" value=\"stacked\" checked> Stacked</label> </form> </div> </div> <div class=\"mdl-grid items\"> <div class=\"mdl-cell mdl-cell--12-col mdl-cell--8-col-tablet mdl-cell--4-col-phone\"> <div class=\"d3-chart\" #chart></div> </div> </div>",
    styles: ["form { font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif; position: absolute; left: 10px; top: 10px; } label { display: block; }"],
